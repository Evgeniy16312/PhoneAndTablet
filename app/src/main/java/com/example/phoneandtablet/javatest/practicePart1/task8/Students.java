...
class Students {
    ...
    public void main(String[] args) {
        ...
        studentsModelList.add(new StudentsModel("Евгений", "Геннадьевич", "Тюрин",
                1992, 5, 503, 4, 4, 3, 5, 5));
        studentsModelList.add(new StudentsModel("Илья", "Николаевич", "Кошкин",
                1995, 3, 302, 3, 4, 5, 4, 3));
        studentsModelList.add(new StudentsModel("Лев", "Алексеевич", "Собакин",
                1996, 2, 202, 5, 3, 5, 5, 5));
        studentsModelList.add(new StudentsModel("Григорий", "Петрович", "Пупкин",
                1992, 5, 503, 5, 4, 5, 4, 5));
        studentsModelList.add(new StudentsModel("Геннадий", "Евгеньевич", "Конин",
                1994, 4, 402, 5, 3, 5, 2, 5));
        studentsModelList.add(new StudentsModel("Алексей", "Александрович", "Медведев",
                1997, 1, 102, 5, 5, 5, 5, 5));
        studentsModelList.add(new StudentsModel("Максим", "Евгеньевич", "Лисий",
                1997, 1, 102, 5, 4, 3, 5, 5));
        studentsModelList.add(new StudentsModel("Костя", "Александрович", "Зайцев",
                1997, 1, 102, 5, 4, 3, 5, 5));
    ...
    public void averageMark(List<StudentsModel> list) {
        ...
        for (Integer i : group) {
            ...
            averageList.addAll(list.stream()
                    .filter(l -> l.getGroupNumber().equals(i))
