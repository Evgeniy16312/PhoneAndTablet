package com.example.phoneandtablet.javatest.practicePart1.task5;
...
public class Users {
    ...
    public static void main(String[] args) {
        ...
        users.subscribers.add(new Subscriber(2342, "Евгений", "Геннадьевич", "Тюрин",
                "Попова 2", 123456, 0, 6, 3, 5));

        users.subscribers.add(new Subscriber(6456, "Илья", "Петрович", "Осинкин",
                "Энгельса 7", 82633, 6, 2, 23, 7));

        users.subscribers.add(new Subscriber(6456, "Роман", "Александрович", "Ложкин",
                "Сурская 4", 3453453, 1, 25, 0, 34));

        users.subscribers.add(new Subscriber(2344, "Екатерина", "Романовна", "Вилкина",
                "Коммунистическая 123", 76345, 4, 75, 45, 65));

        users.subscribers.add(new Subscriber(8678, "Виктор", "Максимович", "Ошуркова",
