package com.example.phoneandtablet.practika.task4;
...
public class Time {
    ...
    private void changeMinute(int minute) throws InvalidDateException {
        if (minute < 0 || minute > 59)
            throw new InvalidDateException("Неверное значение минут", minute);
    ...
    private void changeSecond(int second) throws InvalidDateException {
        if (second < 0 || second > 59)
            throw new InvalidDateException("Неверное значение секунд", second);
